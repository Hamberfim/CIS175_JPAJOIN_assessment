...
/**
 * Servlet implementation class DeleteUserShoppingList
 */
@WebServlet("/deleteUserShoppingList")
public class DeleteUserShoppingList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteUserShoppingList() {
        super();
